...
#define STRING_CONFIG_H_AUTHOR "(nwagers, rubienr, Creality Ender-5 Plus)" // Who made the changes.
...
//#define MACHINE_UUID "c0427b79-ebf9-448c-bc3d-cb7cfc7fc161"
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  28.97,  28.97 }
    #define DEFAULT_Ki_LIST {   2.97,   2.97 }
    #define DEFAULT_Kd_LIST {  70.68,  70.68 }
  #else
    #define DEFAULT_Kp  28.97
...
#define PIDTEMPBED 
  ...
  #define DEFAULT_bedKp 129.98
  #define DEFAULT_bedKi 21.10
  #define DEFAULT_bedKd 533.78
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -41.6, -10.5, -1.5 }
...
#define LCD_BED_TRAMMING
  ...
  #define BED_TRAMMING_INSET_LFRB { 64, 46, 5, 44 } // (mm) Left, Front, Right, Back insets
